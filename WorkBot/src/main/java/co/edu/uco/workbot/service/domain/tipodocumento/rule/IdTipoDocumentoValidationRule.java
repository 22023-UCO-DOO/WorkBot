...
public class IdTipoDocumentoValidationRule implements ValidationRule<UUID> {

	private static final ValidationRule<UUID> instancia = new IdTipoDocumentoValidationRule();
