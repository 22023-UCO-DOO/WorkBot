...
public class HoraFinalizacionHorarioValidationRule implements ValidationRule<Integer> {

	private static final ValidationRule<Integer> instancia = new HoraFinalizacionHorarioValidationRule();
