...
public class HorarioValidationRule implements ValidationRule<TipoDocumentoDomain> {

	private static final ValidationRule<TipoDocumentoDomain> instancia = new HorarioValidationRule();
