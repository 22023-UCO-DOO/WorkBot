...
public class IdCalendarioValidationRule implements ValidationRule<UUID> {

	private static final ValidationRule<UUID> instancia = new IdCalendarioValidationRule();
