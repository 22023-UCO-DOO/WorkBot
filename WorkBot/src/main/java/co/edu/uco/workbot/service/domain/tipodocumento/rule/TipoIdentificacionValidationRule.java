...
public class TipoIdentificacionValidationRule implements ValidationRule<TipoDocumentoDomain> {

	private static final ValidationRule<TipoDocumentoDomain> instancia = new TipoIdentificacionValidationRule();
