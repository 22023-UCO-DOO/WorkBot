...
public class HoraInicioHorarioValidationRule implements ValidationRule<Date> {

	private static final ValidationRule<Date> instancia = new HoraInicioHorarioValidationRule();
