...
public class ConsultarMiembroValidator implements Validator<MiembroDomain>{

	private static final Validator<MiembroDomain> instancia = new ConsultarMiembroValidator();
	private ConsultarMiembroValidator() {
