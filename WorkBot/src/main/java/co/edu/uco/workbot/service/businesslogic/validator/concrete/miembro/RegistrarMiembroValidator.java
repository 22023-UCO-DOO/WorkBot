...
public class RegistrarMiembroValidator implements Validator<MiembroDomain>{

	private static final Validator<MiembroDomain> instancia = new RegistrarMiembroValidator();
	private RegistrarMiembroValidator() {
