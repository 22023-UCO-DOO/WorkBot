...
public class RegistrarEntrenadorValidator implements Validator<CalendarioDomain>{

	private static final Validator<CalendarioDomain> instancia = new RegistrarEntrenadorValidator();
