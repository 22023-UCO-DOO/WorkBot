...
public class IdEstadoEntrenadorValidationRule implements ValidationRule<UUID> {

	private static final ValidationRule<UUID> instancia = new IdEstadoEntrenadorValidationRule();
