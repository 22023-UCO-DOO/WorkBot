...
public class RegistrarHorarioValidator implements Validator<HorarioDomain>{

	private static final Validator<HorarioDomain> instancia = new RegistrarHorarioValidator();
	private RegistrarHorarioValidator() {
