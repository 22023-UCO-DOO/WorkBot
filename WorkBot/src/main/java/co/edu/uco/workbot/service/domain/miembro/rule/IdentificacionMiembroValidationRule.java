...
public class IdentificacionMiembroValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdentificacionMiembroValidationRule();
	...
	private final void validarFormato(final String dato) {
		if(!UtilTexto.contieneSoloNumeros(dato)) {
			throw ServiceWorkBotException.crear("El nombre del tipo de identificación solo puede contener numeros...");
