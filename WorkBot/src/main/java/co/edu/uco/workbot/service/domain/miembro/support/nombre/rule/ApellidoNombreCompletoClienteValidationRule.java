...
public class ApellidoNombreCompletoClienteValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new ApellidoNombreCompletoClienteValidationRule();
