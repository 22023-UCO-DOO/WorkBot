...
public class ModificarHorarioValidator implements Validator<HorarioDomain>{

	private static final Validator<HorarioDomain> instancia = new ModificarHorarioValidator();
	private ModificarHorarioValidator() {
